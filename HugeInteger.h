...
private:
	...
	std::string hugeInt; // each element in the string represents 
	                     // one digit of the number (low digit has lowest index)
	void normalize(); 	// this function normalize the number (deletes zeroes in high digits)
};
